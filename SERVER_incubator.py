...
def addStandardPlayers(board, incubator):
    ...
    def ensureNumWeights(w):
        diff =  incubator.numWeights- len(w)
        if diff:
            new_w = list(w)
            ext = [0,]*diff
            new_w.extend(ext)
    ...
    STANDARDPLAYERS['Raiz'] = parseTPWeights(0.2,0.05,0.1,-0.05,-0.05,-0.1,0,0,-0.7,-0.8,-0.1,0.7,-0.1,0)


    if champs:
        # Epsilon Ported
        STANDARDPLAYERS['Cal9'] = parseTPWeights(1,-0.00688,-0.02755,0.052426,-0.2474,-0.34341,-0.09206,-0.11463,0.37808,-0.46699,-0.44921*2,0.577757,0,0)
        STANDARDPLAYERS['Acnd'] = parseTPWeights(1,-0.010288565,0.023143473,0.003357603,-0.045208527,-0.291372468,0.012108953,-0.14727149,0.456158875,-0.156368715,-0.575275254*2,0.717262457,0,0)
        STANDARDPLAYERS['Lion'] = parseTPWeights(1,-0.013161448,0.025753558,0.006890752,-0.040231418,-0.293013775,0.014284528,-0.153108951,0.464752312,-0.170325176,-0.574609741*2,0.734561248,0,0)
        STANDARDPLAYERS['G3Dy'] = parseTPWeights(1,0.006782764,0.0354006,-0.017738708,-0.060943432,-0.202364151,-0.059767574,0.033646709,0.744256733,0.183438671,-0.43500795*2,0.721879707,0,0)
        # STANDARDPLAYERS['Cal9'] = parseTPWeights(0.02778*1000,-0.00688,-0.02755,0.052426,-0.2474,-0.34341,-0.09206,-0.11463,0.37808,-0.46699,-0.44921*2,0.577757)
        # STANDARDPLAYERS['Acnd'] = parseTPWeights(0.45854458*1000,-0.010288565,0.023143473,0.003357603,-0.045208527,-0.291372468,0.012108953,-0.14727149,0.456158875,-0.156368715,-0.575275254*2,0.717262457,0,0)
        # STANDARDPLAYERS['Lion'] = parseTPWeights(0.472384782*1000,-0.013161448,0.025753558,0.006890752,-0.040231418,-0.293013775,0.014284528,-0.153108951,0.464752312,-0.170325176,-0.574609741*2,0.734561248,0,0)
        # STANDARDPLAYERS['G3Dy'] = parseTPWeights(0.62731144*1000,0.006782764,0.0354006,-0.017738708,-0.060943432,-0.202364151,-0.059767574,0.033646709,0.744256733,0.183438671,-0.43500795*2,0.721879707,0,0)
        ...
        STANDARDPLAYERS['LOmg'] = parseTPWeights(0.4634,-0.021305,-0.02627,0.029645,-0.013075,-0.34785,-0.06516,-0.09723,0.410035,-0.095695,-0.550825,0.71539,0.039705,-0.02993)
        STANDARDPLAYERS['WtX1'] = (0.270309372,0.034075943,0.101739518,0.06710815,0.012442873,-0.115426906,0.640177676,0.124438363,-0.358400911,0.826461614,-0.276241618,-0.547552184,-0.600565597,-0.46342232,0.155087124,0.069294902,0.141114308,-0.24159733)
        STANDARDPLAYERS['WtX2'] = (0.28748,0.05839,0.14166,0.08104,0.0291,-0.07817,0.69236,0.1612,-0.32584,0.74436,-0.21646,-0.58813,-0.5167,-0.5043,0.09655,0.05093,0.15939,-0.34775)
    else:
