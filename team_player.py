...
class TeamPlayer(BasePokerPlayer):
    ...
    lion_w = (0.472384782*1000,-0.013161448,0.025753558,0.006890752,-0.040231418,-0.293013775,0.014284528,-0.153108951,0.464752312,-0.170325176,-0.574609741*2,0.734561248,0,0)
    PLAYERBASE['lion'] = parseTPWeights(lion_w)
    call_w = (0.02778*1000,-0.00688,-0.02755,0.052426,-0.2474,-0.34341,-0.09206,-0.11463,0.37808,-0.46699,-0.44921*2,0.577757,0,0)
    PLAYERBASE['call9996'] = parseTPWeights(call_w)
    ascend_w = (0.45854458*1000,-0.010288565,0.023143473,0.003357603,-0.045208527,-0.291372468,0.012108953,-0.14727149,0.456158875,-0.156368715,-0.575275254*2,0.717262457,0,0)
